...
/* ── Dark + Toss Orange Accent Theme ── */
/* 현재 다크 베이스(#09090b)에 토스 스타일 오렌지 포인트 컬러 적용 */
/* 토스 컬러: 딥 다크 배경 + 밝고 따뜻한 오렌지/코럴 계열 */
const T = {
  bg:          "#09090b",
  bgSec:       "#0c0c0e",
  bgTer:       "#141416",
  ...
  textSec:     "#71717a",
  textMuted:   "#3f3f46",
  accent:      "#FF6B35",       // 토스 스타일 오렌지
  accentBright:"#FF8A50",       // 밝은 오렌지
  accentGlow:  "rgba(255,107,53,0.10)",
  accentBorder:"rgba(255,107,53,0.22)",
  accentText:  "#FFB088",       // 읽기 좋은 소프트 오렌지
...
export default function DarkOrangePreview() {
  return (
    <div style={{ background: T.bg, color: T.text, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", cursor: "auto" }}>
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", padding: "32px 40px 48px", display: "flex", flex: 1, alignItems: "flex-end", gap: 40 }}>
          ...
          <div style={{ width: "50%", position: "relative" }}>
            <div style={{ position: "relative", height: "85vh", borderRadius: 16, overflow: "hidden", border: `1px solid ${T.border}` }}>
              ...
              {/* Orange warm glow behind photo */}
              <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 60% 50% at 50% 30%, rgba(255,107,53,0.05), transparent 70%)" }} />
            </div>
          </div>
        </div>
        {/* Status bar */}
      ...
      <div style={{ background: T.bgSec, padding: "48px 40px", borderTop: `1px solid ${T.border}` }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          <h3 style={{ fontSize: 18, fontWeight: 600, color: T.text, marginBottom: 24 }}>Dark + Toss Orange Accent — Color Palette</h3>
          <div style={{ display: "flex", justifyContent: "center", gap: 12, flexWrap: "wrap" }}>
            {[
              ...
              { color: T.accentBright, label: "Accent Bright" },
